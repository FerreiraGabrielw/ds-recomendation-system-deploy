...
## 1️⃣ Offline Artifacts — Preparação do Modelo para Produção
...
*(Inserir vídeo da tela da AWS aqui)*
...
* Definir métodos (`GET` / `POST`)
* Controlar permissões
* Integrar diretamente com a Lambda
...
*(Inserir vídeo da demo completa aqui)*
