...
```{sql eval=false echo=true code-fold=true code-summary="Show SQL Schema"}
SELECT * FROM XXX
```
...
Nesta etapa, exploramos o comportamento do negócio por meio de SQL, respondendo perguntas como:
* Quais produtos vendem mais?
* Onde está concentrada a receita?
* Existe sazonalidade?
* Como os clientes se distribuem em termos de recência, frequência e gasto?
* Qual o nível de sparsity da matriz cliente × produto?
