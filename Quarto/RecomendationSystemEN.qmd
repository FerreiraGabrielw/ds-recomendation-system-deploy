...
Before building the hybrid model, we evaluated the performance of Item-Item Collaborative Filtering and Content-Based Filtering separately using a Leave-One-Out strategy and the Hit Rate@K metric.
